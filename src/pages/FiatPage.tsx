  ...
  >
    <div className="container mx-auto px-4 max-w-6xl py-12">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-lg mt-2">Un confronto tecnico tra due architetture monetarie diverse.</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left py-2.5 pr-3 font-heading font-semibold text-foreground text-sm">Proprietà</th>
                <th className="text-left py-2.5 px-3 font-heading font-semibold text-foreground text-sm">Bitcoin</th>
                <th className="text-left py-2.5 pl-3 font-heading font-semibold text-foreground text-sm">Monete Fiat</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row, i) => (
                <tr key={i} className={i % 2 === 0 ? "bg-card" : "bg-card-elevated"}>
                  <td className="py-2.5 pr-3 text-sm text-foreground font-medium">{row[0]}</td>
                  <td className="py-2.5 px-3 text-sm text-primary">{row[1]}</td>
                  <td className="py-2.5 pl-3 text-sm text-muted-foreground">{row[2]}</td>
                </tr>
              ))}
            </tbody>
          </table>
